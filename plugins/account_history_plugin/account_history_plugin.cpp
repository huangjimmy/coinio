...
#include <cps/account_history_plugin/account_control_history_object.hpp>
#include <cps/account_history_plugin/account_transaction_history_object.hpp>
#include <cps/account_history_plugin/public_key_history_object.hpp>
#include <cps/account_history_plugin/transaction_history_object.hpp>
...
bool account_history_plugin_impl::is_scope_relevant(const cpsio::types::vector<account_name>& scope)
{
