...
CHAINBASE_SET_INDEX_TYPE( cpsio::account_control_history_object, cpsio::account_control_history_multi_index )

FC_REFLECT( cpsio::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
