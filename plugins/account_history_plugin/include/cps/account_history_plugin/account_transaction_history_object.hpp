...
namespace std {
   ...
   template<>
   struct hash<cpsio::chain::account_name>
   {
    size_t operator()( const cpsio::chain::account_name& name )const
    {
...
CHAINBASE_SET_INDEX_TYPE( cpsio::account_transaction_history_object, cpsio::account_transaction_history_multi_index )

FC_REFLECT( cpsio::account_transaction_history_object, (name)(transaction_id) )
