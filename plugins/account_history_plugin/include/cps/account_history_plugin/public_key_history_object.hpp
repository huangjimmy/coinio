...
namespace std {
   ...
   template<>
   struct hash<cpsio::chain::public_key_type>
   {
      size_t operator()( const cpsio::chain::public_key_type& key ) const
      {
...
CHAINBASE_SET_INDEX_TYPE( cpsio::public_key_history_object, cpsio::public_key_history_multi_index )

FC_REFLECT( cpsio::public_key_history_object, (public_key)(name)(permission) )
