...
#include <cps/net_plugin/protocol.hpp>
#include <chrono>
...
FC_REFLECT( cpsio::select_ids<fc::sha256>, (mode)(pending)(ids) )
FC_REFLECT( cpsio::handshake_message,
            (network_version)(chain_id)(node_id)(key)
            (time)(token)(sig)(p2p_address)
            (last_irreversible_block_num)(last_irreversible_block_id)
            (head_num)(head_id)
            (os)(agent)(generation) )
FC_REFLECT( cpsio::go_away_message, (reason)(node_id) )
FC_REFLECT( cpsio::time_message, (org)(rec)(xmt)(dst) )
FC_REFLECT( cpsio::processed_trans_summary, (id)(outmsgs) )
FC_REFLECT( cpsio::thread_ids, (gen_trx)(user_trx) )
FC_REFLECT( cpsio::block_summary_message, (block_header)(trx_ids) )
FC_REFLECT( cpsio::notice_message, (known_trx)(known_blocks) )
FC_REFLECT( cpsio::request_message, (req_trx)(req_blocks) )
FC_REFLECT( cpsio::sync_request_message, (start_block)(end_block) )
