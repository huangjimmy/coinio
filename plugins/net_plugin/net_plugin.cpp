...
#include <cps/net_plugin/message_buffer.hpp>
...
namespace cpsio {
  ...
  using cpsio::chain::transaction_id_type;
  ...
  void net_plugin::set_program_options( options_description& /*cli*/, options_description& cfg )
  {
    cfg.add_options()
     ...
     ( "agent-name", bpo::value<string>()->default_value("\"CPS Test Agent\""), "The name supplied to identify this node amongst the peers.")
