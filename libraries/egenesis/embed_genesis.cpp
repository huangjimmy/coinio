...
using cpsio::native_contract::genesis_state_type;
...
"// CPS_EGENESIS_JSON to specify an embedded genesis state.          //\n"
"//                                                                  //\n"
;

// hack:  import create_example_genesis() even though it's a way, way
// specific internal detail
namespace cpsio { namespace app { namespace detail {
...
{ try {
   int main_return = 0;
   boost::program_options::options_description cli_options("CPS Chain Identifier");
