...
#define N(X) cpsio::types::string_to_name(#X)
...
namespace fc {
  void to_variant(const cpsio::types::name& c, fc::variant& v);
  void from_variant(const fc::variant& v, cpsio::types::name& check);
  void to_variant(const std::vector<cpsio::types::field>& c, fc::variant& v);
  void from_variant(const fc::variant& v, std::vector<cpsio::types::field>& check);
  void to_variant(const std::map<std::string,cpsio::types::struct_t>& c, fc::variant& v);
  void from_variant(const fc::variant& v, std::map<std::string,cpsio::types::struct_t>& check);
}

FC_REFLECT(cpsio::types::name, (value))
FC_REFLECT(cpsio::types::field, (name)(type))
FC_REFLECT(cpsio::types::struct_t, (name)(base)(fields))
