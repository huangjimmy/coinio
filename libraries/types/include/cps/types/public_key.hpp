...
namespace fc
{
    void to_variant(const cpsio::types::public_key& var,  fc::variant& vo);
    void from_variant(const fc::variant& var,  cpsio::types::public_key& vo);
}

FC_REFLECT(cpsio::types::public_key, (key_data))
FC_REFLECT(cpsio::types::public_key::binary_key, (data)(check))
