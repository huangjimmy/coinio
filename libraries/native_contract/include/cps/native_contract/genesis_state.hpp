...
#include <cps/chain/immutable_chain_parameters.hpp>
...
struct genesis_state_type {
   ...
   blockchain_configuration                  initial_configuration = {
      ...
      config::default_min_cps_balance,
...
FC_REFLECT(cpsio::native_contract::genesis_state_type::initial_account_type,
           (name)(staking_balance)(liquid_balance)(owner_key)(active_key))

FC_REFLECT(cpsio::native_contract::genesis_state_type::initial_producer_type, (owner_name)(block_signing_key))

FC_REFLECT(cpsio::native_contract::genesis_state_type,
