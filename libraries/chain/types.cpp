...
namespace fc {
using cpsio::chain::shared_vector;
void to_variant(const shared_vector<cpsio::types::field>& c, fc::variant& v) {
...
void from_variant(const fc::variant& v, shared_vector<cpsio::types::field>& fields) {
...
void to_variant(const cpsio::chain::producer_round& r, variant& v) {
   v = std::vector<cpsio::chain::account_name>(r.begin(), r.end());
}
void from_variant(const variant& v, cpsio::chain::producer_round& r) {
   auto vector = v.as<std::vector<cpsio::chain::account_name>>();
