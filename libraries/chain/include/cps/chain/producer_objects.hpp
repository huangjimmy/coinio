...
class producer_votes_object : public chainbase::object<producer_votes_object_type, producer_votes_object> {
   ...
   struct {
      ...
      void update(types::share_type currentSpeed, types::uint128 current_position, types::uint128 current_race_time) {
         ...
         CPS_ASSERT(current_race_time <= std::numeric_limits<types::uint128>::max() - projected_time_to_finish,
...
CHAINBASE_SET_INDEX_TYPE(cpsio::chain::producer_votes_object, cpsio::chain::producer_votes_multi_index)
CHAINBASE_SET_INDEX_TYPE(cpsio::chain::proxy_vote_object, cpsio::chain::proxy_vote_multi_index)
CHAINBASE_SET_INDEX_TYPE(cpsio::chain::producer_schedule_object, cpsio::chain::producer_schedule_multi_index)
