...
#include <cps/chain/block_schedule.hpp>
#include <cps/chain/protocol.hpp>
#include <cps/chain/message_handling_contexts.hpp>
#include <cps/chain/chain_initializer_interface.hpp>
...
namespace cpsio { namespace chain {
   ...
   class chain_controller {
      public:
          ...
          *
          * Passing slot_num == 0 returns CPS_NULL_PRODUCER
          */
 ...
 //  protected:
   ...
   private:
         ...
         try {
            CPS_ASSERT(trx.messages.size() > 0, transaction_exception, "A transaction must have at least one message");
