...
FC_REFLECT(cpsio::chain::block_header, (previous)(timestamp)(transaction_merkle_root)(producer)(producer_changes))
FC_REFLECT_DERIVED(cpsio::chain::signed_block_header, (cpsio::chain::block_header), (producer_signature))
FC_REFLECT(cpsio::chain::thread, (generated_input)(user_input) )
FC_REFLECT_DERIVED(cpsio::chain::signed_block, (cpsio::chain::signed_block_header), (cycles))
