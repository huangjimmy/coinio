...
CHAINBASE_SET_INDEX_TYPE(cpsio::chain::generated_transaction_object, cpsio::chain::generated_transaction_multi_index)

FC_REFLECT( cpsio::chain::generated_transaction_object, (trx) )
