...
CHAINBASE_SET_INDEX_TYPE(cpsio::chain::key_value_object, cpsio::chain::key_value_index)
CHAINBASE_SET_INDEX_TYPE(cpsio::chain::keystr_value_object, cpsio::chain::keystr_value_index)
CHAINBASE_SET_INDEX_TYPE(cpsio::chain::key128x128_value_object, cpsio::chain::key128x128_value_index)
CHAINBASE_SET_INDEX_TYPE(cpsio::chain::key64x64x64_value_object, cpsio::chain::key64x64x64_value_index)

FC_REFLECT(cpsio::chain::key_value_object, (id)(scope)(code)(table)(primary_key)(value) )
