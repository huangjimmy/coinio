...
namespace cpsio { namespace chain {
   ...
   using cpsio::types::name;
   using action_name = name;
   using cpsio::types::account_name;
   using cpsio::types::permission_name;
   using cpsio::types::asset;
   using cpsio::types::share_type;
   using cpsio::types::authority;
   using cpsio::types::public_key;
   using cpsio::types::transaction;
   using cpsio::types::permission_name;
   using cpsio::types::type_name;
   using cpsio::types::func_name;
   using cpsio::types::time;
   using cpsio::types::field;
   using cpsio::types::string;
   using cpsio::types::uint8;
   using cpsio::types::uint16;
   using cpsio::types::uint32;
   using cpsio::types::uint64;
   using cpsio::types::uint128;
   using cpsio::types::uint256;
   using cpsio::types::int8;
   using cpsio::types::int16;
   using cpsio::types::int32;
   using cpsio::types::int64;
   using cpsio::types::int128;
   using cpsio::types::int256;
   using cpsio::types::uint128_t;
   ...
   using public_key_type = cpsio::types::public_key;
   
} }  // cpsio::chain

namespace fc {
  void to_variant(const cpsio::chain::shared_vector<cpsio::types::field>& c, fc::variant& v);
  void from_variant(const fc::variant& v, cpsio::chain::shared_vector<cpsio::types::field>& fields);
  void to_variant(const cpsio::chain::producer_round& r, fc::variant& v);
  void from_variant(const fc::variant& v, cpsio::chain::producer_round& r);
}

FC_REFLECT_ENUM(cpsio::chain::object_type,
                (null_object_type)
                (account_object_type)
                (permission_object_type)
                (permission_link_object_type)
