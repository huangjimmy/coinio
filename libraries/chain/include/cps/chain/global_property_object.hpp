...
CHAINBASE_SET_INDEX_TYPE(cpsio::chain::global_property_object, cpsio::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(cpsio::chain::dynamic_global_property_object,
                         cpsio::chain::dynamic_global_property_multi_index)

FC_REFLECT(cpsio::chain::dynamic_global_property_object,
           (head_block_number)
           (head_block_id)
           (time)
           (current_producer)
...
FC_REFLECT(cpsio::chain::global_property_object,
           (configuration)
           (active_producers)
          )
