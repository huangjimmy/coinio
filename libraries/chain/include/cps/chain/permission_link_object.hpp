...
CHAINBASE_SET_INDEX_TYPE(cpsio::chain::permission_link_object, cpsio::chain::permission_link_index)

FC_REFLECT(cpsio::chain::permission_link_object, (id)(account)(code)(message_type)(required_permission))
