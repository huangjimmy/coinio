...
namespace cpsio { namespace chain {
   ...
   /**
    * @brief methods that operate on @ref cpsio::types::Transaction.
    *
    * These are utility methods for sharing common operations between inheriting types which define
    * additional features and requirements based off of @ref cpsio::types::Transaction.
    */
...
FC_REFLECT(cpsio::chain::generated_transaction, (id))
FC_REFLECT_DERIVED(cpsio::chain::signed_transaction, (cpsio::types::signed_transaction), )
FC_REFLECT(cpsio::chain::message_output, (notify)(inline_trx)(deferred_trxs) )
FC_REFLECT_DERIVED(cpsio::chain::processed_transaction, (cpsio::types::signed_transaction), (output) )
FC_REFLECT_DERIVED(cpsio::chain::pending_inline_transaction, (cpsio::types::transaction), )
FC_REFLECT_DERIVED(cpsio::chain::inline_transaction, (cpsio::types::transaction), (output) )
FC_REFLECT(cpsio::chain::processed_generated_transaction, (id)(output) )
FC_REFLECT(cpsio::chain::notify_output, (name)(output) )
