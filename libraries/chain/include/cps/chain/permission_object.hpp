...
CHAINBASE_SET_INDEX_TYPE(cpsio::chain::permission_object, cpsio::chain::permission_index)

FC_REFLECT(chainbase::oid<cpsio::chain::permission_object>, (_id))
FC_REFLECT(cpsio::chain::permission_object, (id)(owner)(parent)(name)(auth))
