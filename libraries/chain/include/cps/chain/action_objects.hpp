...
CHAINBASE_SET_INDEX_TYPE(cpsio::chain::action_permission_object, cpsio::chain::action_permission_index)

FC_REFLECT(cpsio::chain::action_permission_object, (id)(owner)(owner_permission)(scope_permission) )
