...
unsigned int test_string::construct_with_data() {
  ...
  cpsio::string str1(data, size, false);
  ...
  cpsio::string str2(data, 0, false);
...
unsigned int test_string::construct_with_data_partially() {
  ...
  cpsio::string str(data + offset, substr_size, false);
...
unsigned int test_string::construct_with_data_copied() {
  ...
  cpsio::string str1(data, size, true);
...
unsigned int test_string::index_operator() {
  ...
  cpsio::string str(data, size, false);
...
unsigned int test_string::substring() {
  ...
  size_t substr_size = 5;
  size_t offset = 2;
  cpsio::string substr = str.substr(offset, substr_size, false);
...
unsigned int test_string::concatenation_null_terminated() {
  ...
  cpsio::string str1(data1, size1, false);

  char data2[] = "klmnoppqrst";
  size_t size2 = sizeof(data2)/sizeof(char);
  cpsio::string str2(data2, size2, false);
...
unsigned int test_string::valid_utf8() {
  ...
  cpsio::string valid_greek_str(greek_str_data, greek_str_size, false);
  ...
  cpsio::string valid_chinese_str1(chinese_str_data1, chinese_str_size1, false);
  ...
  cpsio::string valid_chinese_str2(chinese_str_data2, chinese_str_size2, false);
...
unsigned int test_string::invalid_utf8() {
  ...
  cpsio::string invalid_chinese_str(chinese_str_data, 5, false);
