...
namespace TOKEN_NAME {
   ...
   */
   typedef cpsio::token<uint64_t,N(currency)> currency_tokens;
   ...
   **/
   using accounts = cpsio::table<N(defaultscope),N(currency),N(account),account,uint64_t>;
