...
extern "C" {
    ...
    *
    *
    * A CPS.IO message has the following abstract structure:
    *
    * ```
    *   struct message {
    ...
    * print(Name(code)); // Output: cps
    *
    * assert(Name(current_code()) === "cps", "This message expects to be received by cps"); // Do nothing
