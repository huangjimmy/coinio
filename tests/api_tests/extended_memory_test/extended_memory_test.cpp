...
extern "C" {
    ...
    void test_extended_memory()
    {
       ...
       ptr1_realloc = (char*)cpsio::realloc(ptr1, 10);
       ...
       ptr1_realloc = (char*)cpsio::realloc(ptr1, 13);
       ...
       ptr1 = ptr1_realloc;
       ptr1_realloc = (char*)cpsio::realloc(ptr1, 972);
       ...
       char* ptr5 = (char*)cpsio::malloc(1020);
       ...
       char* ptr6 = (char*)cpsio::malloc(996);
