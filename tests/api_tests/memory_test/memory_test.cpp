...
extern "C" {
    ...
    void print(const void* const ptr, const uint32_t size)
    {
       ...
       for (uint32_t i = 0; i < size; ++i)
       {
          ...
          cpsio::print("", static_cast<uint32_t>(static_cast<unsigned char>(char_ptr[i])), delim);
       }
       cpsio::print("}\n");
    }
    ...
    void test_memory()
    {
       ...
       char* ptr1_realloc = (char*)cpsio::realloc(ptr1, 30);
       ...
       // 20 chars allocated
       char* ptr2 = (char*)cpsio::malloc(20);
       ...
       ptr1_realloc = (char*)cpsio::realloc(ptr1, 15);
       ...
       ptr1_realloc = (char*)cpsio::realloc(ptr1, 30);
       assert(ptr1_realloc != nullptr, "should have returned a 30 char buf");
       ...
       ptr1_realloc = (char*)cpsio::realloc(ptr1, 36);
       ...
       ptr1_realloc = (char*)cpsio::realloc(ptr1, 37);
       ...
       char* nullptr_realloc = (char*)cpsio::realloc(nullptr, 50);
       ...
       char* invalid_ptr_realloc = (char*)cpsio::realloc(nullptr_realloc + 4, 10);
    ...
    void test_memory_hunk()
    {
       ...
       char* ptr1 = (char*)cpsio::malloc(15 * 64 * 1024 - 4);
    ...
    void test_memory_hunks()
    {
       ...
       char* ptr1 = (char*)cpsio::malloc(7404);
       ...
       for (int i = 0; i < 96; ++i)
       {
          char* ptr2 =  (char*)cpsio::malloc(10 * 1024 - 15);
       ...
       char* ptr3 =  (char*)cpsio::malloc(765);
       ...
       // use all but 8 chars
       char* ptr4 = (char*)cpsio::malloc(764);
    ...
    void test_memory_hunks_disjoint()
    {
       ...
       char* ptr1 = (char*)cpsio::malloc(8 * 1024 - 12);
       ...
       for (int i = 0; i < 14; ++i)
       {
          ...
          loop_ptr1[i] = (char*)cpsio::malloc(64 * 1024 - 28);
       ...
       char* ptr2 = (char*)cpsio::malloc(65412);
       ...
       for (int i = 0; i < 14; ++i)
       {
          ...
          loop_ptr2[i] = (char*)cpsio::malloc(12);
       ...
       for (int i = 0; i < 13; ++i)
       {
          ...
          loop_ptr3[i] = (char*)cpsio::malloc(4);
       ...
       cpsio::free(loop_ptr1[3]);
       cpsio::free(loop_ptr2[3]);
       cpsio::free(loop_ptr3[3]);

       char* slot3_ptr[64];
       for (int i = 0; i < 64; ++i)
       {
          slot3_ptr[i] = (char*)cpsio::malloc(1020);
