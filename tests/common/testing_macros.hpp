 ...
 *
 * @code{.cpp}
 * // Link alice's "money" authority with cpsio::transfer
 * Link_Authority(chain, alice, "money", cps, "transfer");
 * // Set alice's "native" authority as default for cps contract
 * Link_Authority(chain, alice, "money", cps);
 * @endcode
 */
 ...
 *
 * @code{.cpp}
 * // Unlink alice's authority for cpsio::transfer
 * Unlink_Authority(chain, alice, cps, "transfer");
 * // Unset alice's default authority for cps contract
 * Unlink_Authority(chain, alice, cps);
 * @endcode
 */
 ...
 * @code{.cpp}
 * // Send 10 CPS from alice to bob
 * Transfer_Asset(chain, alice, bob, asset(10));
 *
 * // Send 10 CPS from alice to bob with memo "Thanks for all the fish!"
 ...
 * @code{.cpp}
 * // Convert 10 of bob's CPS from liquid to staked
 * Stake_Asset(chain, bob, asset(10).amount);
 *
 * // Stake and transfer 10 CPS from alice to bob (alice pays liquid CPS and bob receives stake)
 ...
 * @code{.cpp}
 * // Begin unstaking 10 of bob's CPS
...
/**
 * @brief Shorthand way to claim unstaked CPS as liquid
 *
 * Use Finish_Unstake_Asset to liquidate unstaked funds:
 * @code{.cpp}
 * // Reclaim as liquid 10 of bob's unstaked CPS
 * Unstake_Asset(chain, bob, asset(10).amount);
 * @endcode
 */
