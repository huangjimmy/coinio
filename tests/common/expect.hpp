...
namespace cpsio { namespace test {
...
#define EXPECT_3(P, E, T) cpsio::test::expect<P>(E,T,"EXPECT<" #P ">(" #E "," #T ")")
#define EXPECT_2(E, T) cpsio::test::expect(E,T,"EXPECT(" #E "," #T ")")
#define EXPECT_1(E) cpsio::test::expect(E,"EXPECT(" #E ")")
