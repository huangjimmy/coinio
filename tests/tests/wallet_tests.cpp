...
#include <cps/wallet_plugin/wallet.hpp>
#include <cps/wallet_plugin/wallet_manager.hpp>
...
#warning TODO: fix check commented out when keys was converted to map<public_key_type,string> 
   ...
   transaction_emplace_message(trx,config::cps_contract_name, vector<types::account_permission>{{sender,"active"}}, "transfer",
