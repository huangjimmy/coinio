...
{ try {
      ...
      {
         cpsio::chain::signed_transaction txn;
         txn.scope = {"currency"};
         txn.messages.resize(1);
         txn.messages[0].code = config::cps_contract_name;
      ...
      cpsio::chain::signed_transaction txn2;
...
{ try {
   ...
   cpsio::chain::signed_transaction txn3;
   ...
   cpsio::chain::signed_transaction txn4;
   ...
   cpsio::chain::signed_transaction txn11;
   ...
   cpsio::chain::signed_transaction txn12;
   ...
   cpsio::chain::signed_transaction txn13;
   ...
   cpsio::chain::signed_transaction txn14;
   ...
   cpsio::chain::signed_transaction txn15;
   ...
   cpsio::chain::signed_transaction txn21;
   ...
   cpsio::chain::signed_transaction txn22;
   ...
   cpsio::chain::signed_transaction txn23;
   ...
   cpsio::chain::signed_transaction txn24;
   ...
   cpsio::chain::signed_transaction txn25;
